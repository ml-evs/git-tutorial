...
\usepackage[colorlinks=true, linkcolor=Cerulean, anchorcolor=Cerulean, urlcolor=Cerulean, citecolor=Cerulean]{hyperref}
\hypersetup{
$if(title-meta)$
            pdftitle={$title-meta$},
$endif$
...
\usepackage{inconsolata}[Scale=0.9]
\usepackage{helvet}
\usepackage{sectsty}
\usepackage{titling}
\allsectionsfont{\sffamily}
\renewcommand{\maketitlehooka}{\bf\sffamily}
...
\lstset{
  ...
  basicstyle=\footnotesize\ttfamily\color{RubineRed},        % the size of the fonts that are used for the code
